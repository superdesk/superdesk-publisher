...
const ImageUpload = ({ upload, href, fieldName, isUploadingInProgress}) => {
    return (
        <div className="sd-line-input">
            ...
            <div className={classNames('sd-overlay-block',{'sd-overlay-block--no-image': !href })}>
                <div className="sd-overlay-block__overlay">
                    <div className="sd-overlay-block__overlay-action-group">
                        <label htmlFor={fieldName} className="sd-overlay-block__overlay-action" sd-tooltip="Upload image"><i className="icon-upload"></i></label>
                        {!href && <span className="sd-overlay-block__overlay-message">No image has been set so far.</span>}
                    </div>
            ...
            <input type='file' id={fieldName} name={fieldName} onChange={upload} style={{opacity: 0, position: 'absolute', width: '1px', height: '1px'}}/>
        </div>
    )
}
